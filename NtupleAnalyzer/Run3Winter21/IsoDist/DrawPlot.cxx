...
{
  TString fileName = "ROOTFile_MakeHist_Validation_CustomIsoFilter_ZMuMu_M50to120.root";
  ...
  canvas->Register( h_IsoMu24Obj,   "IsoMu24 objects", kBlack);
  canvas->Register( h_Mu24Obj,      "Mu24 objects", kBlue);
  canvas->Register( h_Mu24Obj_IsoF, "Mu24 objects + (custom) isolation filter", kRed);
