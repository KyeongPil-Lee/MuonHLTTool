...
#include <Run3Summer21/Utility_TnPHist.h>
...
public:
  ...
  void Fill_Event(MuonHLT::NtupleHandle* ntuple, Double_t eventWeight, Double_t normFactor)
  {
    ...
    if( !ntuple->isRealData )
      h_truePU_->Fill( ntuple->truePU, weight );
...
private:
  ...
  void Init_Hist()
  {
    ...
    h_truePU_ = new TH1D("h_truePU", "", 200, 0, 200); vec_hist_.push_back( h_truePU_ );
