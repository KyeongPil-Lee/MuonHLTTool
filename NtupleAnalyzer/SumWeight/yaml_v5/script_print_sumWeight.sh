...
echo "newHCAL samples"

root -l -b -q ROOTFile_MakeHist_SumWeight_ZMuMu_M50to120_newHCAL.root Print_SumWeight.cxx
root -l -b -q ROOTFile_MakeHist_SumWeight_QCDMuEnriched_Pt20to30_newHCAL.root Print_SumWeight.cxx
root -l -b -q ROOTFile_MakeHist_SumWeight_QCDMuEnriched_Pt30to50_newHCAL.root Print_SumWeight.cxx
root -l -b -q ROOTFile_MakeHist_SumWeight_QCDMuEnriched_Pt50to80_newHCAL.root Print_SumWeight.cxx
root -l -b -q ROOTFile_MakeHist_SumWeight_QCDMuEnriched_Pt80to120_newHCAL.root Print_SumWeight.cxx
root -l -b -q ROOTFile_MakeHist_SumWeight_QCDMuEnriched_Pt120to170_newHCAL.root Print_SumWeight.cxx
